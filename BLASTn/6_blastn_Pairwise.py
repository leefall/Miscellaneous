...
blastn -query "/mnt/towel/Ophthalmology/Preprocess/postrecal/FASTA/ForTublar_'''+str(sID)+'''.fasta" -db /mnt/towel/Ophthalmology/Code/BLAST/KMT2B_target_100.fa -out /mnt/towel/Ophthalmology/Preprocess/postrecal/FASTQ/BLAST/ExactPairwise_'''+str(sID)+'''.txt -evalue 0.00001 -outfmt 0 -task blastn -num_threads 20
