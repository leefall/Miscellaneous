...
def Execute_Score_ANNOVAR(sFile):
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/table_annovar.pl "+"./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/annovar/humandb/ -buildver hg19 -out ./ANNOVAR_Temporaly/Result_Score_"+sFile+" -remove -protocol dbnsfp33a -operation f -nastring NA")
...
def dbSNP(sFile):
	...
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/annotate_variation.pl -filter -buildver hg19 -out ./ANNOVAR_Temporaly/Result_dbSNP_"+sFile+" -dbtype avsnp150 ./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/annovar/humandb/")

def Execute_nonTCGAExAC_ANNOVAR(sFile):
	#print "Gene Annotation"
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/table_annovar.pl "+"./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/annovar/humandb/ -buildver hg19 -out ./ANNOVAR_Temporaly/Result_nonTCGAExAC_"+sFile+" -remove -protocol exac03nontcga -operation f -nastring NA")
...
def gNomad(sFile):
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/table_annovar.pl "+"./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb -buildver hg19 -out ./ANNOVAR_Temporaly/Result_gNomad_"+sFile+" -remove -protocol gnomad211_exome -operation f -nastring NA")


def Execute_TCGA_ANNOVAR(sFile):
        #print "Cosmic Coding annotation"
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/annotate_variation.pl -filter -buildver hg19 -out ./ANNOVAR_Temporaly/Result_TCGA_"+sFile+" -dbtype TCGA_Pool ./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb")
######ANNOVAR END#######

def Execute_Clinvar_ANNOVAR(sFile):
        #print "Cosmic Coding annotation"
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/annotate_variation.pl -filter -buildver hg19 -out ./ANNOVAR_Temporaly/Result_Clinvar_"+sFile+" -dbtype clinvar_20190813 ./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb")

def Execute_ICGC_ANNOVAR(sFile):
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/table_annovar.pl "+"./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb -buildver hg19 -out ./ANNOVAR_Temporaly/Result_ICGC_"+sFile+" -remove -protocol icgc21 -operation f -nastring NA ")

def Execute_Korea1K(sFile):
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/annotate_variation.pl -filter -buildver hg19 -out ./ANNOVAR_Temporaly/Result_Korean1K_"+sFile+" -dbtype KoreanGenome ./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb")

def Execute_Dep(sFile):
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/annotate_variation.pl -filter -buildver hg19 -out ./ANNOVAR_Temporaly/Result_Depression_"+sFile+" -dbtype Depression ./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb")

def Execute_GTEX_ANNOVAR(sFile):
	os.system("/storage/home/leefall2/clara/ANNOVAR/annovar/table_annovar.pl "+"./"+sFile+" /storage/home/leefall2/clara/ANNOVAR/2018_ANNOVAR/annovar/humandb -buildver hg19 -out ./ANNOVAR_Temporaly/Result_GTEX_"+sFile+" -remove -protocol GTEXincludingBeta -operation f -nastring NA ")
...
def ANNOVAR_Annotation(sFile):
	...
	Execute_Frequency_ANNOVAR(sInputfile)
	Execute_Geneanno_ANNOVAR(sInputfile)
#

	Execute_Cosmic_Coding_ANNOVAR(sInputfile)
	Execute_Cosmic_Noncoding_ANNOVAR(sInputfile)
...
#
	...
	Execute_KOVA_ANNOVAR(sInputfile)
	gNomad(sInputfile)
	Execute_TCGA_ANNOVAR(sInputfile)
	Execute_Clinvar_ANNOVAR(sInputfile)

	Execute_ICGC_ANNOVAR(sInputfile)

	
	Execute_Korea1K(sInputfile)
	Execute_Dep(sInputfile)
	Execute_GTEX_ANNOVAR(sInputfile)
